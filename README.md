...
- Course enrollment system with JWT authentication
...
- Manage modules and topics within courses
...
![Teacher courses page](screenshots/teacher_courses.png)

![Teacher add course](screenshots/teacher_add.png)
...
2. **View Course Details**: Click on any course to see its description, modules, topics, and enroll button.
...
4. **Study Theory**: Navigate to the Learning section, select a course, and click on any topic to read the theory content.

![Theory page](screenshots/theory_page.png)

5. **Take Practice Test**: After studying theory, click "Start Practice" to begin answering questions. You can choose between timed and untimed modes if the topic supports both.

![Learning page before](screenshots/learning_page1_before.png)

![Learning page after](screenshots/learning_page1_after.png)

![Timed question](screenshots/single_choice_question.png)

![Multiple choice question](screenshots/multiple_choice_question.png)
...
- `POST /api/teacher/courses/` - Create a new course
  - Request body: `title`, `description`, `modules` (array with nested topics)
...
- Image uploads are handled via FormData and stored in `backend/media/users/`
...
7. Custom images and media integration for course content
